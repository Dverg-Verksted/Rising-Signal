...
{
public:
	FENAnimGraphConnectionDrawingPolicy(int32 InBackLayerID, int32 InFrontLayerID, float ZoomFactor, const FSlateRect& InClippingRect,
	...
	~FENAnimGraphConnectionDrawingPolicy() { delete ConnectionDrawingPolicy; }

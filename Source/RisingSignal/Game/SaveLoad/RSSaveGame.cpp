...
FPlayerSaveData* URSSaveGame::GetPlayerData(APlayerState* PlayerState)
{
    ...
    {
        UE_LOG(LogTemp, Log,
            TEXT("During PIE we cannot use PlayerID to retrieve Saved Player data. Using first entry in array if available."));
